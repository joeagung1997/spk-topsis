<div class="content-header">
        <h2 class="content-header-title">ANALISIS TOPSIS </h2>
        <ol class="breadcrumb">
          <li><a href="#">Home</a></li>
          <li><a href="#">Analisis</a></li>
          <li class="active">Analisis Topsis 1</li>
        </ol>
      </div> <!-- /.content-header -->
...
<form name="form1" method="post" action=""><br>
  ...
  <tr>
  <td id="ignore" bgcolor="#DBEAF5" width="400" colspan="2"><div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif"><font size="2">BOBOT KEPENTINGAN KRITERIA</font> </font></strong></div></td>
  <?php
    $q = mysql_query("select * from tkriteria ORDER BY id_kriteria");
...
<br />
<h4 class="heading">Alternatif terbaik : </h4>  <h4 class="heading"><span class="label label-success"><?php echo $alternatifrangking[0]; ?> </span></h4> Dengan Nilai Terbesar :<h4 class="heading"><span class="label label-primary"> <?php echo $hasilrangking[0]; ?></span></h4><br />
</div>
<br />
...
<br />
<br />
<h4 class="heading">Alternatif Lokasis Terbaik : </h4> <h4 class="heading"><span class="label label-success"><?php echo $alternatifrangking[0]; ?> </span></h4> Dengan Nilai Terbesar : <h4 class="heading"><span class="label label-primary"> <?php echo $hasilrangking[0]; ?></span></h4>
<br />
<?php
}
?>
