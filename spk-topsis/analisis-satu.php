...
<br />
<br />
Alternatif Lokasi Terbaik : <h4 class="heading"> <span class="label label-primary"> <?php echo $alternatifrangking[0]; ?> </span></h4> Dengan Nilai Terbesar : <h4 class="heading"> <span class="label label-success"> <?php echo $hasilrangking[0]; ?></span></h4>
<br />
<br />
