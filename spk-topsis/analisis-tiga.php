...
<form name="form1" method="post" action=""><br>
  ...
  <tbody>
  <?php
    $q = mysql_query("select * from talternatif ORDER BY id_alternatif");
    while ($r = mysql_fetch_array($q)) 
	{ 
	?>        
    <tr>
...
<br />
<br />
<h4 class="heading">Alternatif LokasiTerbaik : </h4><h4 class="heading"><span class="label label-success">  <?php echo $alternatifrangking[0]; ?> </span></h4> <h4 class="heading"> Dengan Nilai Terbesar : </h4><h4 class="heading"><span class="label label-success">  <?php echo $hasilrangking[0]; ?></span></h4>
<br />
<?php
}
?>
